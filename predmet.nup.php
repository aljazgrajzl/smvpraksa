...
<head>
    ...
    <title>Napredna uporaba podatkovnih baz - Spletna Učilnica</title>
    <!-- Bootstrap 5 CSS -->
...
<body>
    ...
    <section class="subject-header">
        <div class="container">
            <h1 class="display-4 fw-bold">Nup</h1>
            <p class="lead">4. letnik - Srednja šola</p>
            <div class="d-flex flex-wrap align-items-center mt-3">
                <div class="me-4">
                    <span class="badge bg-light text-dark p-2"><i class="bi bi-person-check me-1"></i> Prof. Boštjan Lubej</span>
                </div>
                <div class="me-4">
                    <span class="badge bg-light text-dark p-2"><i class="bi bi-people me-1"></i> 24 dijakov</span>
                </div>
                <div>
                    <span class="badge bg-light text-dark p-2"><i class="bi bi-calendar-event me-1"></i> Rok: 15. december 2023</span>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="sidebar">
                    ...
                    <div class="d-flex align-items-center mb-2">
                        ...
                        <div class="flex-grow-1 ms-2">
                            ...
                            <p class="mb-0 small text-muted">5. dec 2023</p>
                        </div>
                    </div>
                    <div class="d-flex align-items-center mb-2">
                        <div class="flex-shrink-0">
                        ...
                        <div class="flex-grow-1 ms-2">
                            ...
                            <p class="mb-0 small text-muted">12. dec 2023</p>
                        </div>
                    </div>
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-2">
                            ...
                            <p class="mb-0 small text-muted">15. dec 2023</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-9">
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <p class="card-text">V tem predmetu bomo spoznavali osnove algebre, geometrije in računanja. Poglavja vključujejo linearne enačbe, kvadratne enačbe, geometrijske oblike in osnove trigonometrije.</p>
                        <p class="card-text">Predmet poteka v prvem letniku srednje šole in je obvezen za vse dijake.</p>
                    </div>
                </div>
                
                <h4 class="mb-4">Aktivne naloge</h4>

                <section id="Naloga"></section>
                
                <!-- Naloga 1 -->
                <div class="card task-card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start mb-2">
                            <h5 class="card-title">Domača naloga 1: Linearne enačbe</h5>
                            <span class="task-status status-in-progress">V poteku</span>
                        </div>
                        <p class="card-text">Rešite naslednji sistem linearnih enačb z uporabo substitucijske metode in odgovorite na vprašanja.</p>
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <span class="text-muted"><i class="bi bi-clock me-1"></i> Rok: 5. december 2023</span>
                                <span class="text-muted ms-3"><i class="bi bi-file-earmark-text me-1"></i> Zahtevnost: Srednja</span>
                            </div>
                            <div>
                                <a href="oddaja-naloge.php" class="btn btn-primary btn-sm">Oddaj rešitev</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card task-card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start mb-2">
                            <h5 class="card-title">Domača naloga 2: Kvadratne enačbe</h5>
                            <span class="task-status status-not-started">Ni začeto</span>
                        </div>
                        <p class="card-text">Rešite naslednje kvadratne enačbe z uporabo kvadratne formule in preverite rešitve.</p>
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <span class="text-muted"><i class="bi bi-clock me-1"></i> Rok: 12. december 2023</span>
                ...
                <div class="card task-card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start mb-2">
                            <h5 class="card-title">Seminarska naloga: Geometrijske oblike</h5>
                            <span class="task-status status-not-started">Ni začeto</span>
                        </div>
                        <p class="card-text">Pripravite seminarsko nalogo o geometrijskih oblikah v vsakdanjem življenju. Naloga naj vključuje vsaj 5 različnih oblik s primeri.</p>
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <span class="text-muted"><i class="bi bi-clock me-1"></i> Rok: 15. december 2023</span>
                                <span class="text-muted ms-3"><i class="bi bi-file-earmark-text me-1"></i> Zahtevnost: Zelo visoka</span>
                            </div>
                            <div>
                                <a href="oddaja-naloge.php" class="btn btn-primary btn-sm">Oddaj rešitev</a>
                            </div>
               ...
               <!-- Gradiva -->
                ...
                <section id="Gradiva"></section>
                <div class="row">
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            <div class="card-body text-center">
                                <i class="bi bi-file-earmark-pdf display-4 text-danger"></i>
                                <h5 class="card-title mt-2">Uvod v algebro</h5>
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <h5 class="card-title mt-2">Vaje za vajo</h5>
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <h5 class="card-title mt-2">Video navodila</h5>
