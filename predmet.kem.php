...
<head>
    ...
    <title>Kemija - Spletna Učilnica</title>
    <!-- Bootstrap 5 CSS -->
...
<body>
    ...
    <section class="subject-header">
        <div class="container">
            <h1 class="display-4 fw-bold">Kemija</h1>
            <p class="lead">4. letnik - Srednja šola</p>
            <div class="d-flex flex-wrap align-items-center mt-3">
                <div class="me-4">
                    <span class="badge bg-light text-dark p-2"><i class="bi bi-person-check me-1"></i> Prof. Janez Novak</span>
                </div>
                <div class="me-4">
            ...
            <div class="col-lg-9">
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <p class="card-text">Pri predmetu Kemija se bomo naučili osnovne kemijske reakcije, periodni sistem, molekule in praktične eksperimente.</p>
                ...
                <div class="card task-card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start mb-2">
                            <h5 class="card-title">Domača naloga 1: Kemijske reakcije</h5>
                            <span class="task-status status-in-progress">V poteku</span>
                        </div>
                        <p class="card-text">Razložite osnovne tipe kemijskih reakcij in napišite primere.</p>
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <a href="#" class="btn btn-primary btn-sm">Oddaj rešitev</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card task-card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start mb-2">
                            <h5 class="card-title">Domača naloga 2: Periodni sistem</h5>
                            <span class="task-status status-not-started">Ni začeto</span>
                        </div>
                        <p class="card-text">Narišite periodni sistem in označite glavne skupine elementov.</p>
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <h5 class="card-title mt-2">Osnove kemije</h5>
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <h5 class="card-title mt-2">Vaje iz kemije</h5>
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <h5 class="card-title mt-2">Video eksperiment</h5>
