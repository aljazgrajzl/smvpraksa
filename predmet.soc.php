...
<head>
    ...
    <title>Sociologija - Spletna Učilnica</title>
    <!-- Bootstrap 5 CSS -->
...
<body>
    ...
    <section class="subject-header">
        <div class="container">
            <h1 class="display-4 fw-bold">Sociologija</h1>
            <p class="lead">4. letnik - Srednja šola</p>
            <div class="d-flex flex-wrap align-items-center mt-3">
                <div class="me-4">
                    <span class="badge bg-light text-dark p-2"><i class="bi bi-person-check me-1"></i> Prof. Ana Horvat</span>
                </div>
                <div class="me-4">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card task-card">
                            <div class="card-body">
                                ...
                                <h3 class="card-title mb-3">88%</h3>
                                <div class="progress">
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card task-card">
                            <div class="card-body">
                                ...
                                <h3 class="card-title">13/15</h3>
                                <small class="text-success">Zelo dobro napreduješ!</small>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mb-4">
                        <div class="card task-card">
                            <div class="card-body">
                                ...
                                <h3 class="card-title">4 dni</h3>
                                <small class="text-warning">Raziskovalna naloga</small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card task-card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <h5 class="card-title mb-0">Družbene spremembe</h5>
                                    <span class="task-status status-in-progress">V delu</span>
                                </div>
                                <p class="card-text">Analizirajte vpliv družbenih sprememb na mlado generacijo v Sloveniji.</p>
                        ...
                        <div class="card task-card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <h5 class="card-title mb-0">Sociološka raziskava</h5>
                                    <span class="task-status status-not-started">Ni začeto</span>
                                </div>
                                <p class="card-text">Izvedite manjšo raziskavo o vplivu socialnih omrežij na komunikacijo med mladimi.</p>
                                <div class="d-flex justify-content-between align-items-center">
    ...
    <footer class="footer">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <h5>O predmetu</h5>
                    <p>Sociologija je družbena veda, ki preučuje človeško družbo, njene strukture in procese družbenega življenja.</p>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <h5>Kontakt</h5>
                    <p>Prof. Ana Horvat<br>ana.horvat@sola.si</p>
                </div>
            </div>
            <hr class="mt-4">
