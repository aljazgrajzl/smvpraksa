...
<head>
    ...
    <title>Računalniški praktikum - Spletna Učilnica</title>
    <!-- Bootstrap 5 CSS -->
...
<body>
    ...
    <section class="subject-header">
        <div class="container">
            <h1 class="display-4 fw-bold">Računalniški praktikum</h1>
            <p class="lead">4. letnik - Srednja šola</p>
            <div class="d-flex flex-wrap align-items-center mt-3">
                <div class="me-4">
                    <span class="badge bg-light text-dark p-2"><i class="bi bi-person-check me-1"></i> Prof. Jaka Koren</span>
                </div>
                <div class="me-4">
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <div class="card task-card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start mb-2">
                            <h5 class="card-title">Domača naloga 1: osnove računalništva</h5>
                            <span class="task-status status-in-progress">V poteku</span>
                        </div>
                        <p class="card-text">Odgovorite na naslednja vprašanja, ki se nanašajo na snov iz prejšnjih letnikov</p>
                ...
                <div class="card task-card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start mb-2">
                            <h5 class="card-title">Domača naloga 2: Nadaljevanje programiranja</h5>
                            <span class="task-status status-not-started">Ni začeto</span>
                        </div>
                        <p class="card-text">Rešite naslednje račune v binarnem številskem sistemu. pazite na pravilno število bitov..</p>
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                ...
                <div class="card task-card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start mb-2">
                            <h5 class="card-title">Seminarska naloga: spletna stran s podatkovno bazao</h5>
                            <span class="task-status status-not-started">Ni začeto</span>
                        </div>
                        <p class="card-text">Pripravite seminarsko nalogo v povezavi s podatkovno bazo. pravilno ju povežite da se bodo ob registraciji pravilno zapisovali dijaki in posebaj uredite tudi prijavo za administratorja.</p>
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <h5 class="card-title mt-2">Računanje v dvojiškem številskem sistemu.
                                </h5>
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <h5 class="card-title mt-2">Vaje za računanje.</h5>
