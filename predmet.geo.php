...
<head>
    ...
    <title>Geografija - Spletna Učilnica</title>
    <!-- Bootstrap 5 CSS -->
...
<body>
    ...
    <section class="subject-header">
        <div class="container">
            <h1 class="display-4 fw-bold">Geografija</h1>
            <p class="lead">4. letnik - Srednja šola</p>
            <div class="d-flex flex-wrap align-items-center mt-3">
                <div class="me-4">
                    <span class="badge bg-light text-dark p-2"><i class="bi bi-person-check me-1"></i> Prof. Jana Novak</span>
                </div>
                <div class="me-4">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card task-card">
                            <div class="card-body">
                                ...
                                <h3 class="card-title mb-3">85%</h3>
                                <div class="progress">
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card task-card">
                            <div class="card-body">
                                ...
                                <h3 class="card-title">12/15</h3>
                                <small class="text-success">Dobro napreduješ!</small>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mb-4">
                        <div class="card task-card">
                            <div class="card-body">
                                ...
                                <h3 class="card-title">5 dni</h3>
                                <small class="text-warning">Oddaja seminarske naloge</small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card task-card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <h5 class="card-title mb-0">Raziskava podnebnih sprememb</h5>
                                    <span class="task-status status-in-progress">V delu</span>
                                </div>
                                <p class="card-text">Pripravite seminarsko nalogo o vplivu podnebnih sprememb na lokalno okolje.</p>
                        ...
                        <div class="card task-card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <h5 class="card-title mb-0">Analiza geografskih kart</h5>
                                    <span class="task-status status-not-started">Ni začeto</span>
                                </div>
                                <p class="card-text">Preučite priložene geografske karte in pripravite analizo območja.</p>
                                <div class="d-flex justify-content-between align-items-center">
    ...
    <footer class="footer">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <h5>O predmetu</h5>
                    <p>Geografija je predmet, ki raziskuje zemeljsko površje ter odnose med človekom in njegovim okoljem.</p>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <h5>Kontakt</h5>
                    <p>Prof. Jana Novak<br>jana.novak@sola.si</p>
                </div>
            </div>
            <hr class="mt-4">
